...
palavras = {
  facil: ['rins', 'uretra'],
  medio: ['ureteres', 'nefrons'],
  dificil: ['bexiga', 'bacinete']
};
...
function sortearPalavra() {
  ...
  if(palavraSorteada == "rins"){
    alert('Pergunta: \nÓrgão no formato de um feijão, com a função de filtrar o sangue para eliminar substâncias nocivas?')
  }
  if(palavraSorteada == "nefrons"){
    alert('Pergunta: \nA principal unidade estrutural e funcional dos rins é o?')
  }
  if(palavraSorteada == "ureteres"){
    alert('Pergunta: \nA urina é conduzida dos rins para a bexiga urinária através dos?')
  }
  if(palavraSorteada == "bexiga"){
    alert('Pergunta: \nSua função é receber a urina que chega continuamente dos ureteres, armazenando-a até o momento de sua eliminação')
  }
  if(palavraSorteada == "uretra"){
    alert('Pergunta: \nA urina é eliminada da bexiga urinária pela? ')
  }
  if(palavraSorteada == "bacinete"){
    alert('Pergunta: \nÓrgão responsável pela coleta de urina?')
  }
